...
data, data2  = load_data(), pd.read_csv(DATA_URL2, encoding='utf-8')
...
if len(choice) > 0:
  ...
  fig_choice = px.bar(choice_data, x='name', y='comment_number')
  st.plotly_chart(fig_choice)
...
if not st.sidebar.checkbox("Скрыть", True, key='7'):
